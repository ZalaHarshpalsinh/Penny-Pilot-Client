    ...
    const transactions = [
        {
            ...
            type: "Income",
            amount: 5000,
            transactionDateTime: new Date("2024-10-01"),
            category: {
                name: "Salary",
                icon: "https://via.placeholder.com/50",
            }, // Use a real icon URL for better visuals
            toMoneyPool: { name: "Bank Account" },
        },
        {
            _id: "2",
            title: "Grocery",
            ...
            type: "Expense",
            amount: 150,
            transactionDateTime: new Date("2024-10-02"),
            category: {
                name: "Groceries",
                icon: "https://via.placeholder.com/50",
            },
            fromMoneyPool: { name: "Cash" },
        },
        {
            _id: "3",
            title: "Lend to John",
            type: "Lend",
            amount: 200,
            transactionDateTime: new Date("2024-10-05"),
            dummyFriend: { name: "John Doe" },
        },
    ];
